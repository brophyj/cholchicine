...
![Figure 1 Probability density plot for CLEAR data](output/clear_vague.png)  {{< pagebreak >}} ![Figure 2 Probability density plot for COLOT data](output/colcot_vague.png)\
{{< pagebreak >}} ![Figure 3 Probability density function for CLEAR with COLOT as prior](output/clear_colcot.png)  {{< pagebreak >}} ![Figure 4 Bayesian hierarchical meta-analysis](output/brms_hier.png)\
{{< pagebreak >}}
